...
console.log(`Last Car is a ${lastCar.car_year} ${lastCar.car_make} ${lastCar.car_model}`);

// ==== Challenge 3 ====
// The marketing team wants the car models listed alphabetically on the website. Sort all the car model names into alphabetical order and log the results in the console
let carModels = [];
const modelIterator = inventory.values();
for (let model of modelIterator) {
    carModels.push(model.car_model);  
};

console.log('carModels alphabetical ===> ', carModels.sort());


// ==== Challenge 4 ====
// The accounting team needs all the years from every car on the lot. Create a new array from the dealer data containing only the car years and log the result in the console.
let carYears = [];
const yearIterator = inventory.values();
for (let year of yearIterator) {
...
// console.log(oldCars);
console.log('Cars older than year 2000 ===>', oldCars.length); 
...
;}
console.log('AUDI and BMW cars ===> ', JSON.stringify(BMWAndAudi));
